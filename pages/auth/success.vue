    ...
    <div class="relative min-h-screen flex items-center justify-center">
      <div class="text-center max-w-2xl mx-auto px-4">
        <div v-if="loading" class="flex flex-col items-center">
          ...
          <h2 class="text-xl font-semibold text-white">Setting up your account...</h2>
          <p class="text-white/70 mt-2">Please wait while we complete your registration.</p>
        </div>
        ...
        <div v-else class="glass-dark rounded-2xl p-8">
          ...
          <div class="bg-accent-500/20 border border-accent-500/30 rounded-lg p-4 mb-6">
            <div class="flex items-start">
              <svg class="h-5 w-5 text-accent-400 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
              </svg>
              <div class="text-left">
                <h3 class="text-sm font-medium text-accent-300">Next Step: Set Your Password</h3>
        ...
        <div class="space-y-4">
          ...
          >
            ...
            <div class="text-sm text-white/70">
              <p>Questions? <NuxtLink to="/contact" class="text-primary-400 hover:text-primary-300">Contact our support team</NuxtLink></p>
            </div>
        </div>

          <!-- Plan details -->
          <div class="mt-8 pt-6 border-t border-white/20">
            <h3 class="text-sm font-medium text-white mb-3">Your Subscription Details</h3>
            <div class="bg-background-800/50 rounded-lg p-4 text-left">
              <div v-if="planDetails" class="space-y-2">
                <div class="flex justify-between items-center">
                  <span class="text-sm text-white/70">Plan:</span>
                  <span class="text-sm font-medium text-white capitalize">{{ planDetails.plan }}</span>
                </div>
                <div class="flex justify-between items-center">
                  <span class="text-sm text-white/70">Status:</span>
                  <span class="text-sm font-medium text-accent-400">Trial Active</span>
                </div>
                <div class="flex justify-between items-center">
                  <span class="text-sm text-white/70">Trial Period:</span>
                  <span class="text-sm font-medium text-white">14 days free</span>
                </div>
              </div>
            </div>
          </div>
